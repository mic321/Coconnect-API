...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Geolocation.created'
        db.add_column(u'mobile_geolocation', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 6, 30, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Geolocation.created'
        db.delete_column(u'mobile_geolocation', 'created')
